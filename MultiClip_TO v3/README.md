...
Текущая версия 3.2.0.51 от 25 [июня 2015 года](https://en.wikipedia.org/wiki/June_2015).<br>
...
### Горячие клавиши
Для каждого шаблона после табуляции можно указывать горячую клавишу в формате: `[Ctrl+][Shift+][Alt+]Буква`. Например, `Ctrl+F1`, `Alt+L`, `F10`.<br>
