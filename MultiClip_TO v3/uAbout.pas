...
begin
	ShellExecute(Handle, 'open', 'mailto:antynik@yandex.ru?bcc=ssglobov@gmail.com&subject=Multiclip%20v2.2.3.44', nil, nil, SW_SHOWNORMAL);
end;
...
begin
	ShellExecute(Handle, 'open', 'mailto:ssglobov@gmail.com&subject=Multiclip%20v2.2.3.44', nil, nil, SW_SHOWNORMAL);
end;
